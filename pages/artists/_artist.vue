    ...
    <div class="catalog-grid" :class="{ 'is-menu': isMenu }">
      ...
      <div class="second-row-container">
          ...
          <div v-if="currentFocus === 'artist'" class="DataSection__sectionContainer">
            ...
            <div id="artinfo" class="DataSection__col DataSection__rightCol is-blur">
              ...
              <div class="DataSection__textContainer">
                <p>Musdam quia non parchil ictemperitae venda qui bersperit rendi sedi con- senist, optas aligenis qui ut es aut officim inulpari core si nonsequia non ea venecte renimol uptatii stiundis eumquuntis aut veliciendit que lab ide enit quodit voluptiatus rem aut et offic tempos quate eos ea pos dernat lam, ut quodia volo erum utempore</p>
              </div>
            </div>
          </div>
        </div> -->
        ...
        <div class="DataSection middle-section" :class="[{ 'is-active': currentFocus === 'insititution'}, currentFocus]">
          <h3 class="DataSection__sectionTitle" @click="currentFocus = 'insititution'">
            Institution
          </h3>
          ...
          <div id="artwork" class="DataSection__col DataSection__midCol">
            ...
            <div class="DataSection__richtextContainer">
              ...
              <figure>
                <img src="~/static/placeholder4.jpeg">
              </figure>
            </div>
          </div>
          ...
          <div id="artinfo" class="DataSection__col DataSection__rightCol">
            ...
            <div class="DataSection__textContainer">
              <p>
                Cum audam nisci assin- velique volleces quatquo quatus soluptio dollam comniat.
                Nequuntis inctor sint od maione nonsequoditi non nos autem. Caboribusa simi, ium que quaerem alignih iliquiae vollatur, accus essusae ligenim aut velenis sequae pa veriae odi remporiant vollique repercius et que vendi dolorep erovid ex
              </p>
            </div>
          </div> <!-- end of Info -->
        ...
        <!-- Company -->
        <div class="DataSection right-section" :class="[{ 'is-active': currentFocus === 'company'}, currentFocus]">
          <h3 class="DataSection__sectionTitle" @click="currentFocus = 'company'">
            Companies
          </h3>
          ...
          <!-- Information -->
          <div id="artwork" class="DataSection__col DataSection__midCol is-active">
            <h4 class="DataSection__sectionTitle">
              Information
            </h4>
            <div class="DataSection__richtextContainer">
              <figure>
